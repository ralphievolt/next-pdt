...
import { Button, Center, NumberInput, Paper, Select, Space, TextInput, Title } from '@mantine/core';
          ...
          <Controller
            ...
            render={({ field }) => (
              <NumberInput
                ...
                {...field}
                error={errors.quantity && 'Quantity is required and must be at least 1'}
              />
            )}
          />
          <Space h="xl" />
